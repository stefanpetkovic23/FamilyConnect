...
class PrivateActivityAdapter (private var activities: List<ActivityFull>,private val viewModel: MonthCalendarViewModel) : RecyclerView.Adapter<PrivateActivityAdapter.ActivityViewHolder>() {
    ...
    fun setData(newData: List<ActivityFull>) {
        activities = newData
    ...
    inner class ActivityViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(activity: ActivityFull) {
            ...
            deleteImageView.setOnClickListener {
                viewModel.deleteActivity(activity._id)
            }
